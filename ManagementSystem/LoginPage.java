...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setFont(new java.awt.Font("Trebuchet MS", 1, 21)); // NOI18N
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, 130, 40));

        jPasswordField1.setFont(new java.awt.Font("Trebuchet MS", 1, 21)); // NOI18N
        jPasswordField1.setText("jPasswordField1");
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 240, 130, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(userName.contentEquals("user") && password.contentEquals("password")){
            ...
            JOptionPane.showMessageDialog(null, "Entered Username or Password is incorrect");
        }
